    ...
    create or replace table `data-eng-ipeds`.`dbt_echristiansen`.`obt_completions`
      
    partition by range_bucket(
            survey_year,
            generate_array(2018, 2035, 1)
        )
    cluster by institution_name, cip_title, state_abbreviation, award_level_description
